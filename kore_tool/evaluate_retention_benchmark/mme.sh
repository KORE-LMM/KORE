...
python -m llava.eval.model_vqa_loader \
    ...
    --question-file /hkfs/work/workspace/scratch/lmu_chd4938-MINED_26/MINED_26/data_ckpt/dataset/MME/llava_mme.jsonl \
    --image-folder /hkfs/work/workspace/scratch/lmu_chd4938-MINED_26/MINED_26/data_ckpt/dataset/MME/MME_Benchmark_release_version/MME_Benchmark \
    --answers-file "/hkfs/work/workspace/scratch/lmu_chd4938-MINED_26/MINED_26/data_ckpt/dataset/MME/answers/$FINAL_EXPERIMENT_NAME.jsonl" \
    --temperature 0 \
    --conv-mode vicuna_v1

cd /hkfs/work/workspace/scratch/lmu_chd4938-MINED_26/MINED_26/data_ckpt/dataset/MME

# Use extracted experiment name
python convert_answer_to_mme.py --experiment "$FINAL_EXPERIMENT_NAME"

cd /hkfs/work/workspace/scratch/lmu_chd4938-MINED_26/MINED_26/data_ckpt/dataset/MME/eval_tool
