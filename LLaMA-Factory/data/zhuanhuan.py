...
def main():
    # 设置输入和输出文件路径
    input_file = "/hkfs/work/workspace/scratch/lmu_chd4938-MINED_26/LLaVA_8_8_null_space/train_data/random_train_data_seed42.json"  # 请替换为你的输入文件名
    output_file = "/hkfs/work/workspace/scratch/lmu_chd4938-MINED_26/Qwen2.5-VL-null-space/LLaMA-Factory/data/new_random_train_data_seed42.json"  # 输出文件名
